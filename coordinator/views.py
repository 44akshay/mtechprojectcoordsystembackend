...
def getStudentDataAndAvail(request):
    ...
    # return Response({'chair': chair_serializer.data,'committee':committee_serializer.data,'project_name':project_instance.projectname,'guide_name':project_instance.guide.name,'isCommittee':isCommittee},status=200)
    return Response({'chair': chair_serializer.data,'committee':committee_serializer.data,'project_name':project_instance.projectname,'guide_name':project_instance.guide.name,'isCommittee':isCommittee,'chair_sugg':project_instance.sugg_chair,'committee1_sugg':project_instance.sugg_mem1,'committee2_sugg':project_instance.sugg_mem2},status=200)
...
def setCommittee(request):
    ...
    if chair_instance.ischair<limit_object.ChairPerson :
        ...
        return Response({"message":"Chair Exceeded"},status=400)
    if committee1_instance.iscommem<limit_object.CommitteeLimit :
        ...
        return Response({"message":"committee Exceeded"},status=400)
    ...
    project_instance = Project.objects.get(rollNoId=rollno)
    if project_instance.chair_person:
        return Response({"message":"Committee Set"},status=400)
